...
SWIGINTERN PyObject *_wrap_get_long_size(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "get_long_size", 0, 0, 0)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_check_for_isolated_junctions(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "check_for_isolated_junctions", 6, 6, swig_obj)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1 
    };
  ...
  {
    array3 = obj_to_array_no_conversion(swig_obj[1], NPY_LONG);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "get_long_size", _wrap_get_long_size, METH_NOARGS, NULL},
	 { "check_for_isolated_junctions", _wrap_check_for_isolated_junctions, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
