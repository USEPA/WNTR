...
def check_for_isolated_junctions(sources, node_indicator, indptr, indices, data, num_connections):
    return _network_isolation.check_for_isolated_junctions(sources, node_indicator, indptr, indices, data, num_connections)
check_for_isolated_junctions = _network_isolation.check_for_isolated_junctions
