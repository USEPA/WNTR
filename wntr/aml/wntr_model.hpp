...
{
public:
  std::unordered_set<std::shared_ptr<ExpressionBase> > vars;
  std::unordered_set<std::shared_ptr<ConstraintBase> > cons;
  std::vector<std::shared_ptr<ConstraintBase> > cons_vector;
  std::vector<std::shared_ptr<ExpressionBase> > vars_vector;
  ...
  void add_var(std::shared_ptr<ExpressionBase>);
  void remove_var(std::shared_ptr<ExpressionBase>);
