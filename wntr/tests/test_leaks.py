...
class TestLeakResults(unittest.TestCase):
    ...
    def test_leak_demand(self):
        ...
        active_control_action = self.wntr.network.TargetAttributeControlAction(leak1, 'leak_status', True)
        inactive_control_action = self.wntr.network.TargetAttributeControlAction(leak1, 'leak_status', False)
