...
class TestLeakAdditionAndRemoval(unittest.TestCase):
    ...
    def test_add_leak(self):
        ...
        wn.split_pipe('pipe1','pipe1__B','leak1')
        ...
        self.assertEqual(pipe.end_node, 'leak1')
...
class TestLeakResults(unittest.TestCase):
    ...
    def test_leak_demand(self):
        ...
        control = self.wntr.network.controls.Control.time_control(wn, 4*3600, 'SIM_TIME', False, active_control_action)
        wn.add_control('control1', control)
        control = self.wntr.network.controls.Control.time_control(wn, 8*3600, 'SIM_TIME', False, inactive_control_action)
