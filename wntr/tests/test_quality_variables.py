...
class Test(unittest.TestCase):
    ...
    def test_ReactionVariable_reserved_name_exception(self):
        self.assertRaises(ValueError, wntr.quality.BulkSpecies, "D", "mg")
        self.assertRaises(ValueError, wntr.quality.WallSpecies, "Q", "mg")
    ...
    def test_RxnVariable_symbols_and_sympy(self):
        species1 = wntr.quality.BulkSpecies("Cl", "mg")
    ...
    def test_RxnVariable_string_functions(self):
        species1 = wntr.quality.BulkSpecies("Cl", "mg")
        species2 = wntr.quality.WallSpecies("Cl", "mg", 0.01, 0.0001, note="Testing stuff")
        const1 = wntr.quality.Constant("Kb", 0.482)
    ...
    def test_BulkSpecies_creation(self):
        ...
        self.assertRaises(TypeError, wntr.quality.BulkSpecies, "Re")
        self.assertRaises(ValueError, wntr.quality.BulkSpecies, "Re", "mg")
        self.assertRaises(TypeError, wntr.quality.BulkSpecies, "Cl", "mg", 0.01)
        self.assertRaises(TypeError, wntr.quality.BulkSpecies, "Cl", "mg", None, 0.01)
        species = wntr.quality.BulkSpecies("Cl", "mg")
    ...
    def test_WallSpecies_creation(self):
        ...
        self.assertRaises(TypeError, wntr.quality.WallSpecies, "Re")
        self.assertRaises(ValueError, wntr.quality.WallSpecies, "Re", "mg")
        self.assertRaises(TypeError, wntr.quality.WallSpecies, "Cl", "mg", 0.01)
        self.assertRaises(TypeError, wntr.quality.WallSpecies, "Cl", "mg", None, 0.01)
        species = wntr.quality.WallSpecies("Cl", "mg")
        self.assertEqual(species.name, "Cl")
        self.assertEqual(species.units, "mg")
    ...
    def test_Constant_creation(self):
        ...
        self.assertEqual(const1.get_value(), const1.global_value)
        self.assertEqual(const1.var_type, wntr.quality.VariableType.CONST)
    ...
    def test_Parameter_creation(self):
        ...
        self.assertEqual(param1.var_type, wntr.quality.VariableType.PARAM)
    ...
    def test_RxnTerm_creation(self):
        ...
        self.assertEqual(term1.var_type, wntr.quality.VariableType.TERM)
    ...
    def test_Equilibrium_creation(self):
        ...
        self.assertEqual(equil1.expr_type, wntr.quality.DynamicsType.EQUIL)

    def test_Rate_creation(self):
        rate1 = wntr.quality.RateDynamics("Cl", wntr.quality.LocationType.TANK, "-Ka + Kb * Cl + T0", note="Foo Bar")
        self.assertEqual(rate1.species, "Cl")
        self.assertEqual(rate1.expression, "-Ka + Kb * Cl + T0")
        self.assertEqual(rate1.expr_type, wntr.quality.DynamicsType.RATE)
    ...
    def test_WaterQualityReactionsModel_creation_specific_everything(self):
        ...
        param1 = wntr.quality.Parameter("Ka", 0.482, note="foo")
        term1 = wntr.quality.OtherTerm("T0", "-3.2 * Kb * Cl^2", note="bar")
        equil1 = wntr.quality.EquilibriumDynamics(bulk1, wntr.quality.LocationType.PIPE, "-Ka + Kb * Cl + T0")
        rate1 = wntr.quality.RateDynamics(bulk1, wntr.quality.LocationType.TANK, "-Ka + Kb * Cl + T0", note="Foo Bar")
        formula1 = wntr.quality.FormulaDynamics(wall1, wntr.quality.LocationType.PIPE, "-Ka + Kb * Cl + T0")
    ...
    def test_WaterQualityReactionsModel_creation_generic_species_coeffs(self):
        ...
        wall3 = rxn_model2.add_species(wntr.quality.VariableType.WALL, "ClOH", "mg", 0.01, 0.0001, note="Testing stuff")
        const3 = rxn_model2.add_coefficient("Consolation", "Kb", 0.482)
        param3 = rxn_model2.add_coefficient(wntr.quality.VariableType.P, "Ka", 0.482, note="foo")
