...
class TestSegmentation(unittest.TestCase):
    ...
    def test_valve_criticality_length(self):
        ...
        assert_series_equal(valve_crit, expected_valve_crit, check_dtype=False, check_names=False)
    ...
    def test_valve_criticality(self):
        ...
        valve_crit = wntr.metrics.topographic._valve_criticality(self.valves, 
                                self.node_segments, self.link_segments)
        ...
        assert_series_equal(valve_crit, expected_valve_crit, 
