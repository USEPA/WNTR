...
class Test(unittest.TestCase):
    ...
    def test_MsxModel_creation_specific_everything(self):
        ...
        rxn_model1.add_source('Cl', 'Dummy1', 1.23)
        rxn_model1.add_source('Cl', 'Dummy2', 2.7)
        source = rxn_model1.get_sources_for_species('Cl')
        self.assertDictEqual(source, {'Dummy1':1.23, 'Dummy2':2.7})
        rxn_model1.remove_source('Cl','Dummy1')
        source = rxn_model1.get_sources_for_species('Cl')
        self.assertDictEqual(source, {'Dummy2':2.7})
