...
class Test(unittest.TestCase):
    ...
    def test_BulkSpecies_creation(self):
        ...
        self.assertEqual(species.var_type, wntr.reaction.model.RxnVariableType.BULK)
    ...
    def test_WallSpecies_creation(self):
        ...
        self.assertEqual(species.name, "Cl")
        self.assertEqual(species.units, "mg")
        self.assertEqual(species.var_type, wntr.reaction.model.RxnVariableType.WALL)
        self.assertIsNone(species.atol)
        self.assertIsNone(species.rtol)
        self.assertIsNone(species.note)
    ...
    def test_Constant_creation(self):
        ...
        self.assertEqual(const1.get_value(), const1.global_value)
        self.assertEqual(const1.var_type, wntr.reaction.model.RxnVariableType.CONST)
    ...
    def test_Parameter_creation(self):
        ...
        self.assertEqual(param1.var_type, wntr.reaction.model.RxnVariableType.PARAM)
    ...
    def test_RxnTerm_creation(self):
        ...
        self.assertEqual(term1.var_type, wntr.reaction.model.RxnVariableType.TERM)
        self.assertEqual(term1.note, "bar")

    def test_RxnExpression_strings(self):
        equil1 = wntr.reaction.model.EquilibriumDynamics("Cl", wntr.reaction.model.RxnLocationType.PIPE, "-Ka + Kb * Cl + T0")
        rate1 = wntr.reaction.model.RateDynamics("Cl", wntr.reaction.model.RxnLocationType.TANK, "-Ka + Kb * Cl + T0", note="Foo Bar")
        formula1 = wntr.reaction.model.FormulaDynamics("Cl", wntr.reaction.model.RxnLocationType.PIPE, "-Ka + Kb * Cl + T0")
    ...
    def test_Equilibrium_creation(self):
        ...
        self.assertEqual(equil1.expr_type, wntr.reaction.model.RxnDynamicsType.EQUIL)

    def test_Rate_creation(self):
        rate1 = wntr.reaction.model.RateDynamics("Cl", wntr.reaction.model.RxnLocationType.TANK, "-Ka + Kb * Cl + T0", note="Foo Bar")
        self.assertEqual(rate1.species, "Cl")
        self.assertEqual(rate1.expression, "-Ka + Kb * Cl + T0")
        self.assertEqual(rate1.expr_type, wntr.reaction.model.RxnDynamicsType.RATE)
    ...
    def test_Formula_creation(self):
        ...
        self.assertEqual(formula1.expr_type, wntr.reaction.model.RxnDynamicsType.FORMULA)
    ...
    def test_WaterQualityReactionsModel_creation_specific_everything(self):
        ...
        param1 = wntr.reaction.model.Parameter("Ka", 0.482, note="foo")
        term1 = wntr.reaction.model.OtherTerm("T0", "-3.2 * Kb * Cl^2", note="bar")
        equil1 = wntr.reaction.model.EquilibriumDynamics(bulk1, wntr.reaction.model.RxnLocationType.PIPE, "-Ka + Kb * Cl + T0")
        rate1 = wntr.reaction.model.RateDynamics(bulk1, wntr.reaction.model.RxnLocationType.TANK, "-Ka + Kb * Cl + T0", note="Foo Bar")
        formula1 = wntr.reaction.model.FormulaDynamics(wall1, wntr.reaction.model.RxnLocationType.PIPE, "-Ka + Kb * Cl + T0")
        ...
        rate2 = rxn_model1.add_tank_reaction("Cl", wntr.reaction.model.RxnDynamicsType.R, "-Ka + Kb * Cl + T0", note="Foo Bar")
    ...
    def test_WaterQualityReactionsModel_creation_generic_species_coeffs(self):
        ...
        self.assertRaises(ValueError, rxn_model2.add_species, wntr.reaction.model.RxnVariableType.CONST, "Cl", "mg")
        ...
        wall3 = rxn_model2.add_species(wntr.reaction.model.RxnVariableType.WALL, "ClOH", "mg", 0.01, 0.0001, note="Testing stuff")
        const3 = rxn_model2.add_coefficient("Consolation", "Kb", 0.482)
        param3 = rxn_model2.add_coefficient(wntr.reaction.model.RxnVariableType.P, "Ka", 0.482, note="foo")
