...
class Test(unittest.TestCase):
    ...
    def test_RxnVariable_symbols_and_sympy(self):
        ...
        const1 = wntr.reaction.model.ConstantCoeff("Kb", 0.482)
        symbol2 = sympy.symbols("Kb")
        self.assertEqual(const1.symbol, symbol2)

        param1 = wntr.reaction.model.ConstantCoeff("Ka", 0.482)
        symbol3 = sympy.symbols("Ka")
        self.assertEqual(param1.symbol, symbol3)

        term1 = wntr.reaction.model.FunctionalTerm("T0", "-3.2 * Kb * Cl^2", note="bar")
    ...
    def test_RxnVariable_values(self):
        ...
        const1 = wntr.reaction.model.ConstantCoeff("Kb", 0.482, note="test")
        self.assertEqual(const1.get_value(), const1.value)
        test_pipe_dict = {"PIPE": 0.38}
        test_tank_dict = {"TANK": 222.23}
        param2 = wntr.reaction.model.ParameterizedCoeff("Kb", 0.482, note="test", pipe_values=test_pipe_dict, tank_values=test_tank_dict)
    ...
    def test_RxnVariable_string_functions(self):
        ...
        const1 = wntr.reaction.model.ConstantCoeff("Kb", 0.482)
        param1 = wntr.reaction.model.ParameterizedCoeff("Ka", 0.482, note="foo")
        term1 = wntr.reaction.model.FunctionalTerm("T0", "-3.2 * Kb * Cl^2", note="bar")
    ...
    def test_BulkSpecies_creation(self):
        ...
        self.assertEqual(species.species_type, wntr.reaction.model.RxnVarType.Bulk)
        ...
        self.assertEqual(species.variable_type, wntr.reaction.model.RxnVarType.Bulk)
        self.assertEqual(species.name, "Cl")
        self.assertEqual(species.value, "mg")
    ...
    def test_WallSpecies_creation(self):
        ...
        self.assertEqual(species.value, "mg")
        self.assertEqual(species.value, species.unit)
        self.assertEqual(species.species_type, wntr.reaction.model.RxnVarType.Wall)
        self.assertIsNone(species.Atol)
        self.assertIsNone(species.Rtol)
        self.assertIsNone(species.note)
        species = wntr.reaction.model.WallSpecies("Cl", "mg", 0.01, 0.0001, note="Testing stuff")
        self.assertEqual(species.variable_type, wntr.reaction.model.RxnVarType.Wall)
        self.assertEqual(species.name, "Cl")
        self.assertEqual(species.value, "mg")
        self.assertEqual(species.Atol, 0.01)
        self.assertEqual(species.Rtol, 0.0001)
    ...
    def test_Constant_creation(self):
        self.assertRaises(TypeError, wntr.reaction.model.ConstantCoeff, "Re")
        self.assertRaises(ValueError, wntr.reaction.model.ConstantCoeff, "Re", 2.48)
        const1 = wntr.reaction.model.ConstantCoeff("Kb", 0.482, note="test")
        ...
        self.assertEqual(const1.coeff_type, wntr.reaction.model.RxnVarType.Constant)
        self.assertEqual(const1.note, "test")

    def test_Parameter_creation(self):
        self.assertRaises(TypeError, wntr.reaction.model.ParameterizedCoeff, "Re")
        self.assertRaises(ValueError, wntr.reaction.model.ParameterizedCoeff, "Re", 2.48)
        param1 = wntr.reaction.model.ParameterizedCoeff("Kb", 0.482, note="test")
        ...
        self.assertEqual(param1.coeff_type, wntr.reaction.model.RxnVarType.Parameter)
    ...
    def test_RxnTerm_creation(self):
        self.assertRaises(TypeError, wntr.reaction.model.FunctionalTerm, "Re")
        self.assertRaises(ValueError, wntr.reaction.model.FunctionalTerm, "Re", "1.0*Re")
        term1 = wntr.reaction.model.FunctionalTerm("T0", "-3.2 * Kb * Cl^2", note="bar")
        self.assertEqual(term1.name, "T0")
        self.assertEqual(term1.expression, "-3.2 * Kb * Cl^2")
        self.assertEqual(term1.variable_type, wntr.reaction.model.RxnVarType.Term)
    ...
    def test_RxnExpression_direct_instantiation_exceptions(self):
        self.assertRaises(TypeError, wntr.reaction.model.RxnExpression, "Cl", wntr.reaction.model.RxnLocType.Pipes)
        self.assertRaises(NotImplementedError, wntr.reaction.model.RxnExpression, "Cl", wntr.reaction.model.RxnLocType.Pipes, "-Ka + Kb * Cl + T0")
    ...
    def test_RxnExpression_strings(self):
        equil1 = wntr.reaction.model.EquilibriumExpression("Cl", wntr.reaction.model.RxnLocType.Pipes, "-Ka + Kb * Cl + T0")
        rate1 = wntr.reaction.model.RateExpression("Cl", wntr.reaction.model.RxnLocType.Tanks, "-Ka + Kb * Cl + T0", note="Foo Bar")
        formula1 = wntr.reaction.model.FormulaExpression("Cl", wntr.reaction.model.RxnLocType.Pipes, "-Ka + Kb * Cl + T0")
    ...
    def test_Equilibrium_creation(self):
        ...
        self.assertEqual(equil1.expression_type, wntr.reaction.model.RxnExprType.Equil)

    def test_Rate_creation(self):
        rate1 = wntr.reaction.model.RateExpression("Cl", wntr.reaction.model.RxnLocType.Tanks, "-Ka + Kb * Cl + T0", note="Foo Bar")
        self.assertEqual(rate1.species, "Cl")
        self.assertEqual(rate1.expression, "-Ka + Kb * Cl + T0")
        self.assertEqual(rate1.expression_type, wntr.reaction.model.RxnExprType.Rate)
    ...
    def test_Formula_creation(self):
        ...
        self.assertEqual(formula1.expression_type, wntr.reaction.model.RxnExprType.Formula)
    ...
    def test_WaterQualityReactionsModel_creation_specific_everything(self):
        ...
        param1 = wntr.reaction.model.ParameterizedCoeff("Ka", 0.482, note="foo")
        term1 = wntr.reaction.model.FunctionalTerm("T0", "-3.2 * Kb * Cl^2", note="bar")
        equil1 = wntr.reaction.model.EquilibriumExpression(bulk1, wntr.reaction.model.RxnLocType.Pipes, "-Ka + Kb * Cl + T0")
        rate1 = wntr.reaction.model.RateExpression(bulk1, wntr.reaction.model.RxnLocType.Tanks, "-Ka + Kb * Cl + T0", note="Foo Bar")
        formula1 = wntr.reaction.model.FormulaExpression(wall1, wntr.reaction.model.RxnLocType.Pipes, "-Ka + Kb * Cl + T0")
        ...
        rate2 = rxn_model1.add_tank_reaction("Cl", wntr.reaction.model.RxnExprType.Rate, "-Ka + Kb * Cl + T0", note="Foo Bar")
        formula2 = rxn_model1.add_reaction("pipes", "ClOH", "formula", "-Ka + Kb * Cl + T0")
    ...
    def test_WaterQualityReactionsModel_creation_generic_species_coeffs(self):
        ...
        self.assertRaises(ValueError, rxn_model2.add_species, wntr.reaction.model.RxnVarType.Species, "Cl", "mg")
    ...
    def test_WaterQualityReactionsModel_creation_generic_variables_reactions(self):
        ...
        self.assertRaises(ValueError, rxn_model2.add_variable, wntr.reaction.model.RxnVarType.Species, "Cl", "mg")
        self.assertRaises(ValueError, rxn_model2.add_variable, None, "Kb", 0.482)

        bulk3 = rxn_model2.add_variable("Bulk", "Cl", "mg")
        wall3 = rxn_model2.add_variable(wntr.reaction.model.RxnVarType.Wall, "ClOH", "mg", 0.01, 0.0001, note="Testing stuff")
        const3 = rxn_model2.add_variable("Consolation", "Kb", 0.482)
        param3 = rxn_model2.add_variable(wntr.reaction.model.RxnVarType.P, "Ka", 0.482, note="foo")
