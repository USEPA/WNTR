"""
The GIS data files created using this script are stored in examples/data and 
used in gis.rst. 

The data has no CRS, the units are based on Net1. However, when the geojson 
files are read back into a geopandas DataFrame, the CRS is assumed to be 
epsg:4326 https://epsg.io/4326, World Geodetic System in degrees.
