...
# Modify Controls
wn_event._cps_reg["TANK-3354-plc"].change_control(" IF TANK TANK-3343 LEVEL BELOW 8.65632 THEN PUMP PUMP-3863 STATUS IS OPEN PRIORITY 3", "control 70", "LINK PUMP-3863 OPEN IF Node TANK-3343 BELOW 9.65632 PRIORITY 6", "control 69")
