...
#20 21 22 1 3 2 5 4 7 6 9 8 11 10 13 12

#pump_stations = {
#    '2': ['PUMP-3830', 'PUMP-3831', 'PUMP-3832', 'PUMP-3833', 'PUMP-3834']}
...
for k,v in pump_stations.iteritems():
    ...
    #percent_demand_met.mean(axis=1).plot(label='Average', color='k', linewidth=2.0, legend=False)
    plt.ylim( (-0.05, 1.05) )
    #plt.legend(loc='best')
    ...
    plt.legend()
    """
pickle.dump(pyomo_results, open('all_scenario_results.pickle', 'wb'))
