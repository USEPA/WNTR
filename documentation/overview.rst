...
The python package is **compatible with EPANET 2.00.12 [Ross00]_and 2.2.0 [EPANET22]_.**
...
* **Generate water network models** from scratch or from existing EPANET-formatted water network model input (EPANET INP) files [EPANET22, Ross00]_ 
