...
class TestNetworkTimeErrors(unittest.TestCase):
    ...
    def test_pattern_start_time(self):
        inp_file = resilienceMainDir+'/epanetlib/tests/networks_for_testing/net_test_8.inp'
    ...
    def test_report_time_step(self):
        inp_file = resilienceMainDir+'/epanetlib/tests/networks_for_testing/net_test_9.inp'
        wn = self.en.network.WaterNetworkModel()
        parser = self.en.network.ParseWaterNetwork()
    ...
    def test_report_start_time(self):
        inp_file = resilienceMainDir+'/epanetlib/tests/networks_for_testing/net_test_10.inp'
        wn = self.en.network.WaterNetworkModel()
        parser = self.en.network.ParseWaterNetwork()
    ...
    def test_start_clocktime(self):
        inp_file = resilienceMainDir+'/epanetlib/tests/networks_for_testing/net_test_11.inp'
        wn = self.en.network.WaterNetworkModel()
        parser = self.en.network.ParseWaterNetwork()
...
class TestNetworkTimeBehavior(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        inp_file = resilienceMainDir+'/epanetlib/tests/networks_for_testing/net_test_12.inp'
        wn = self.en.network.WaterNetworkModel()
        parser = self.en.network.ParseWaterNetwork()
        parser.read_inp_file(wn, inp_file)
        sim = self.en.sim.PyomoSimulator(wn, 'DEMAND DRIVEN')
