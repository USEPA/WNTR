...
def test_Net1():
    ...
    expected_elevation = {'11': 710.0, 
                          ...
                          '31': 700.0, 
                          '2':  850.0}
    expected_elevation = en.units.convert('Elevation', flowunits, expected_elevation)
    ...
    expected_base_demand = {'11': 150, 
                            ...
                            '32': 100, 
                            '31': 100}
    expected_base_demand = en.units.convert('Demand', flowunits, expected_base_demand)
    ...
    expected_diameter = {'11':  14.0, 
                         ...
                         '31':   6.0,
                         '110': 18.0}
    expected_diameter = en.units.convert('Pipe Diameter', flowunits, expected_diameter)
    ...
    expected_length = {'11':  5280.0, 
                       ...
                       '31':  5280.0,
                       '110':  200.0}
    expected_length = en.units.convert('Length', flowunits, expected_length)
