...
class NetResults(object):
    ...
    def plot_node_attribute(self, nodes_to_plot=None, param = 'demand', nodeType = None):
        ...
        for name in nodes:
            ...
            plt.plot(self.time,values,label=name)
        plt.legend()
        plt.xlabel('time')
        plt.ylabel(param)
    ...
    def plot_link_attribute(self, links_to_plot=None, param = 'flowrate', linkType = None):
